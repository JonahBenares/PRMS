		...
		<section class="items-center justify-center py-8">
			<div class="bg-white rounded-lg shadow-lg max-w-6xl mx-auto">
				...
				<div class="px-6 py-4 flex justify-between items-center mb-4 bg-white border-b rounded-t-lg">
					<h2 class="text-lg font-semibold">Location (Item )List</h2>
					<button 
				...
				<div class="px-6 pt-2 pb-6">
					<table
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            >
                                <td class="px-4 py-2 align-top">{{ location.name }}</td>
                ...
                <div class="bg-white rounded-lg w-[600px] absolute top-32">
                    ...
                    <div class="flex flex-col gap-3 px-6 py-4">
                        <div class="flex flex-col gap-1">
                            ...
                            <input v-model="modalItem.name" placeholder="Location (Item) Name" class="border px-3 py-2 rounded text-sm"/>
                        </div>
                    </div>
...
const saveLocation = () => {
  if (isEdit.value) {
    const index = locations.findIndex(i => i.id === modalItem.id);
    if (index !== -1) locations[index] = { ...modalItem };
  } else {
    locations.push({ ...modalItem, id: Date.now() });
  }
