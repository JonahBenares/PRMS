				...
				<div class="px-6 pt-2 pb-6">
					<table
                        ...
                        <thead class="bg-gray-100 text-gray-900 font-semibold">
                            <tr>
                                <td class="px-4 py-2 cursor-pointer">Name</td>
                                <td class="px-4 py-2 cursor-pointer">Email</td>
                                <td class="px-4 py-2 cursor-pointer">Role</td>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            >
                                ...
                                <td class="px-4 py-2 align-top">{{ user.role }}</td>
                ...
                <div class="bg-white rounded-lg w-[600px] absolute top-32">
                    ...
                    <div class="flex flex-col gap-3 px-6 py-4">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <input v-model="modalItem.role" placeholder="Role" class="border px-3 py-2 rounded text-sm"/>
                        </div>
                    </div>
...
const saveUser = () => {
  if (isEdit.value) {
    const index = users.findIndex(i => i.id === modalItem.id);
    if (index !== -1) users[index] = { ...modalItem };
  } else {
    users.push({ ...modalItem, id: Date.now() });
  }
