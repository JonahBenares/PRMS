		...
		<section class="items-center justify-center py-8">
			<div class="bg-white rounded-lg shadow-lg max-w-6xl mx-auto">
              ...
              <thead class="bg-gray-100 text-gray-900 font-semibold">
                  <tr>
                  <td class="px-4 py-2 cursor-pointer">Purpose Name</td>
              ...
              <tbody class="divide-y divide-gray-200">
                  ...
                  >
                  <td class="px-4 py-2 align-top">{{ purpose.name }}</td>
                ...
                <div class="bg-white rounded-lg w-[600px] absolute top-32">
                    ...
                    <div class="flex flex-col gap-3 px-6 py-4">
                        <div class="flex flex-col gap-1">
                            <label class="text-sm" for=""> Purpose</label>
                            <input placeholder="Purpose" class="border px-3 py-2 rounded text-sm"/>
                        </div>
                    </div>
...
const purposes = reactive([
  { id: 1, name: "Inventory Replenishment" },
  { id: 2, name: "IT and Technology" },
  { id: 3, name: "Operational Needs" },
]);
...
const savePurpose = () => {
  if (isEdit.value) {
    const index = purposes.findIndex(i => i.id === modalItem.id);
    if (index !== -1) purposes[index] = { ...modalItem };
  } else {
    purposes.push({ ...modalItem, id: Date.now() });
  }
